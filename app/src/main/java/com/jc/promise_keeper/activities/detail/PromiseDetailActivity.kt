package com.jc.promise_keeper.activities.detail
...
class PromiseDetailActivity : UtilityBase.BaseAppCompatActivity<ActivityPromiseDetailBinding>(R.layout.activity_promise_detail) {
